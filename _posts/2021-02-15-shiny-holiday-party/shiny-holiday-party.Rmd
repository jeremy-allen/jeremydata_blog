...
In addition to picking a name, the app also searches IMDB movie plot summaries for that name, picks a random one from the results and shows it in the app without the movie title. Then every tries to guess the movie title. There is a "reveal" button to reveal the movie title. 
